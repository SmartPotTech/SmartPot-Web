      ...
      <div className="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden w-4xl">
        <div className="relative h-40">
          ...
          <div className="absolute -bottom-12 left-6">
            <div className="w-30 h-30 rounded-full border-4 text-white border-white bg-gradient-to-br from-emerald-400 to-cyan-500 shadow-md flex items-center justify-center">
