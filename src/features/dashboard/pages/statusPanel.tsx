...
export default function StatusPanel() {
    ...
    const formatMeasure = (value?: number, suffix = ""): string =>
        value == null || Number.isNaN(value) ? "Sin datos" : `${value.toFixed(2)}${suffix}`;
    ...
    return (
        <div className="w-full max-w-full">
            ...
            <aside
                className="estado-cultivo mb-6 mt-7 p-4 rounded-lg bg-white text-green-800 flex items-center rounded-lg shadow-md p-3 gap-3 hover:shadow-lg transition-shadow duration-200">
            ...
            <div className="sensors grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4 w-full mb-6">
                <CropCard
                    ...
                    category="Humedad"
                    title={formatMeasure(measures?.humidity, "%")}
                    isLoading={isLoading}
                />
                ...
                <CropCard
                    ...
                    category="pH"
                    title={formatMeasure(measures?.ph)}
                    isLoading={isLoading}
                />
                ...
                <CropCard
                    ...
                    title={formatMeasure(measures?.temperature, " Cº")}
                    isLoading={isLoading}
                />
                ...
                <CropCard
                    ...
                    title={formatMeasure(measures?.brightness, " LUX")}
                    isLoading={isLoading}
                />
                ...
                <CropCard
                    ...
                    imageAlt="Cultivo"
                    category="TDS"
                    title={formatMeasure(measures?.tds, " ppm")}
                    isLoading={isLoading}
                />
            </div>
